    ...
    translations: {
        ...
        form: {
          ...
          flowbuilder: {
            welcomeFlow: {
              ...
              description: "Este fluxo é disparado apenas para novos contatos, pessoas que você não possui em sua lista de contatos e que mandaram uma mensagem",
            },
            defaultResponseFlow: {
              title: "Fluxo de resposta padrão",
              description: "Resposta Padrão é enviada com qualquer caractere diferente de uma palavra chave. ATENÇÃO! Será disparada se o atendimento já estiver fechado.",
            },
      ...
      settings: {
        ...
        settings: {
          ...
          acronyms: {
            title: "Configuração de Siglas para Cópia de Contatos"
          },
          payment: {
            efi: "EFI",
            efiClientId: "ID do Cliente EFI",
            efiClientSecret: "Segredo do Cliente EFI",
            efiPixKey: "Chave PIX EFI",
            mercadoPago: "Mercado Pago",
            mercadoPagoAccessToken: "Token de Acesso Mercado Pago",
            stripe: "Stripe",
            stripePrivateKey: "Chave Privada Stripe",
            asaas: "ASAAS",
