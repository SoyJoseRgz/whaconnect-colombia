...
const Dashboard = () => {
  ...
  const [dateFrom, setDateFrom] = useState(moment("1", "D").locale('en').format("YYYY-MM-DD"));
                        ...
                        <Grid2 xs={12} sm={6} md={12}>
                          <Paper elevation={3}>
                            ...
                            >
                              ...
                              {i18n.t("dashboard.assessments.evaluationIndex")}: {formatPercentage(counters.percRating / 100)} <br></br>
                            </Typography>
                          </Paper>
                        </Grid2>
