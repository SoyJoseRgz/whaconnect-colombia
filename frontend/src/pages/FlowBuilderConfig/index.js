...
const nodeCategories = [
  {
    name: i18n.t("flowBuilder.nodeCategories.basic"),
    color: theme => theme.palette.primary.main,
    icon: <RocketLaunch />,
    nodes: [
      {
        icon: <RocketLaunch />,
        name: i18n.t("flowBuilder.nodes.start.name"),
        type: "start",
        description: i18n.t("flowBuilder.nodes.start.description")
      }
    ]
  },
  {
    name: i18n.t("flowBuilder.nodeCategories.content"),
    color: theme => theme.palette.success.main,
    icon: <LibraryBooks />,
    nodes: [
      {
        icon: <LibraryBooks />,
        name: i18n.t("flowBuilder.nodes.content.name"),
        type: "content",
        description: i18n.t("flowBuilder.nodes.content.description")
      },
      {
        icon: <Message />,
        name: i18n.t("flowBuilder.nodes.text.name"),
        type: "text",
        description: i18n.t("flowBuilder.nodes.text.description")
      }
    ]
  },
  {
    name: i18n.t("flowBuilder.nodeCategories.interaction"),
    color: theme => theme.palette.warning.main,
    icon: <DynamicFeed />,
    nodes: [
      {
        icon: <DynamicFeed />,
        name: i18n.t("flowBuilder.nodes.menu.name"),
        type: "menu",
        description: i18n.t("flowBuilder.nodes.menu.description")
      },
      {
        icon: <QuestionAnswerIcon />,
        name: i18n.t("flowBuilder.nodes.input.name"),
        type: "input",
        description: i18n.t("flowBuilder.nodes.input.description")
      },
      {
        icon: <AccessTime />,
        name: i18n.t("flowBuilder.nodes.interval.name"),
        type: "interval",
        description: i18n.t("flowBuilder.nodes.interval.description")
      }
    ]
  },
  {
    name: i18n.t("flowBuilder.nodeCategories.logic"),
    color: theme => theme.palette.secondary.main,
    icon: <CallSplit />,
    nodes: [
      {
        icon: <CallSplit />,
        name: i18n.t("flowBuilder.nodes.randomizer.name"),
        type: "random",
        description: i18n.t("flowBuilder.nodes.randomizer.description")
      }
    ]
  },
  {
    name: i18n.t("flowBuilder.nodeCategories.system"),
    color: theme => theme.palette.info.main,
    icon: <Queue />,
    nodes: [
      {
        icon: <Queue />,
        name: i18n.t("flowBuilder.nodes.queues.name"),
        type: "ticket",
        description: i18n.t("flowBuilder.nodes.queues.description")
      },
      {
        icon: <Tag />,
        name: i18n.t("flowBuilder.nodes.tags.name"),
        type: "tag",
        description: i18n.t("flowBuilder.nodes.tags.description")
      },
      {
        icon: <Tag />,
        name: i18n.t("flowBuilder.nodes.removeTag.name"),
        type: "removeTag",
        description: i18n.t("flowBuilder.nodes.removeTag.description")
      },
      {
        icon: <ArrowForwardIcon />,
        name: i18n.t("flowBuilder.nodes.switchFlow.name"),
        type: "switchFlow",
        description: i18n.t("flowBuilder.nodes.switchFlow.description")
      },
      {
        icon: <Person />,
        name: i18n.t("flowBuilder.nodes.attendant.name"),
        type: "attendant",
        description: i18n.t("flowBuilder.nodes.attendant.description")
      }
    ]
  },
  {
    name: i18n.t("flowBuilder.nodeCategories.integrations"),
    color: theme => theme.palette.error.main,
    icon: <HttpIcon />,
    nodes: [
      {
        icon: <HttpIcon />,
        name: i18n.t("flowBuilder.nodes.httpRequest.name"),
        type: "httpRequest",
        description: i18n.t("flowBuilder.nodes.httpRequest.description")
      },
      {
        icon: <DataObjectIcon />,
        name: i18n.t("flowBuilder.nodes.variable.name"),
        type: "variable",
        description: i18n.t("flowBuilder.nodes.variable.description")
      },
      {
        icon: <SiOpenai />,
        name: i18n.t("flowBuilder.nodes.gemini.name"),
        type: "gemini",
        description: i18n.t("flowBuilder.nodes.gemini.description")
      },
      {
        icon: <SiOpenai />,
        name: i18n.t("flowBuilder.nodes.openai.name"),
        type: "openai",
        description: i18n.t("flowBuilder.nodes.openai.description")
      }
    ]
  }
];
...
const initialNodes = [
  {
    ...
    data: { label: i18n.t("flowBuilder.nodes.start.nodeLabel") },
    type: "start"
  }
];
...
const QuickActions = ({ onActionClick }) => {
  ...
  const quickActions = [
    { icon: <Message />, name: i18n.t("flowBuilder.quickActions.text"), type: "text" },
    { icon: <DynamicFeed />, name: i18n.t("flowBuilder.quickActions.menu"), type: "menu" },
    { icon: <AccessTime />, name: i18n.t("flowBuilder.quickActions.interval"), type: "interval" },
    { icon: <LibraryBooks />, name: i18n.t("flowBuilder.quickActions.content"), type: "content" }
  ];
...
export const FlowBuilderConfig = () => {
    ...
    <Slide direction="up" in={bottomSheetOpen} mountOnEnter unmountOnExit>
      <div className={classes.bottomSheet}>
        ...
        <div className={classes.bottomSheetHeader}>
          <Typography variant="h6">{i18n.t("flowBuilder.sidebar.title")}</Typography>
    ...
    return (
      <div className={classes.root}>
        <div className={classes.header}>
          <MainHeader>
            <Title>{i18n.t("flowBuilder.header.title")}</Title>
          </MainHeader>
        </div>
 ...
 <div className={classes.root}>
          ...
          <div className={classes.sidebarHeader}>
            {sidebarOpen && (
              <Typography variant="subtitle1" fontWeight="bold">
                {i18n.t("flowBuilder.sidebar.title")}
              </Typography>
            )}
            <IconButton 
    ...
    <Fab
      ...
      onClick={saveFlow}
      title={i18n.t("flowBuilder.header.save")}
    >
      <SaveIcon />
    </Fab>
