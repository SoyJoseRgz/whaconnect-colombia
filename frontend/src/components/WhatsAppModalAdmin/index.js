...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  const [importOldMessages, setImportOldMessages] = useState(moment().add(-1, "days").locale('en').format("YYYY-MM-DDTHH:mm"));
  const [importRecentMessages, setImportRecentMessages] = useState(moment().add(-1, "minutes").locale('en').format("YYYY-MM-DDTHH:mm"));
