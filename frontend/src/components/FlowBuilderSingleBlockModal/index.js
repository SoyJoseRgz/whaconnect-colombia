...
const FlowBuilderSingleBlockModal = ({
  ...
  const [labels, setLabels] = useState({
    title: i18n.t("flowBuilderSingleBlockModal.labels.title"),
    btn: i18n.t("flowBuilderSingleBlockModal.labels.btn"),
  });
  ...
  const handleElements = (newNameFiles) => {
    ...
    for (let i = 0; i < numberMessages; i++) {
      ...
      if (!value) {
        toast.error(i18n.t("flowBuilderSingleBlockModal.toasts.emptyMessageFields"));
        setLoading(false);
        throw "";
      }
  ...
  const handleChangeMediasImg = (e, number) => {
    ...
    if (e.target.files[0].size > 2000000) {
      toast.error(i18n.t("flowBuilderSingleBlockModal.toasts.fileTooLarge2mb"));
      return;
    }
  ...
  const handleChangeAudios = (e, number) => {
    ...
    if (e.target.files[0].size > 5000000) {
      toast.error(i18n.t("flowBuilderSingleBlockModal.toasts.fileTooLarge5mb"));
      return;
    }
    ...
    ${i18n.t("flowBuilderSingleBlockModal.misc.browserNotSupportHTML5")}
  </audio>`;
  ...
  const handleChangeVideos = (e, number) => {
    ...
    if (e.target.files[0].size > 20000000) {
      toast.error(i18n.t("flowBuilderSingleBlockModal.toasts.fileTooLarge20mb"));
      return;
    }
  ...
  const imgLayout = (number, valueDefault = "") => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.image")}</Typography>
        ...
        {valueDefault.length === 0 && (
          ...
          >
            {i18n.t("flowBuilderSingleBlockModal.buttons.sendImage")}
            <input
              type="file"
  ...
  const audioLayout = (number, valueDefault = "", valueRecordDefault = "") => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.audio")}</Typography>
        <div
        ...
        {valueDefault.length === 0 && (
          ...
          >
            {i18n.t("flowBuilderSingleBlockModal.buttons.sendAudio")}
            <input
              type="file"
        ...
        <Stack direction={"row"} justifyContent={"center"}>
          ...
          <Stack justifyContent={"center"}>
            <Typography>{i18n.t("flowBuilderSingleBlockModal.checkboxLabels.sendAsRecordedAudio")}</Typography>
          </Stack>
        </Stack>
      </Stack>
    );
  ...
  const videoLayout = (number, valueDefault = "") => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.video")}</Typography>
        <div
        ...
        {valueDefault.length === 0 && (
          ...
          >
            {i18n.t("flowBuilderSingleBlockModal.buttons.sendVideo")}
            <input
              type="file"
              accept="video/mp4"
              hidden
  ...
  const messageLayout = (number, valueDefault = "") => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.text")}</Typography>
        <TextField
          label={i18n.t("flowBuilderSingleBlockModal.textFieldLabels.message")}
  ...
  const intervalLayout = (number, valueDefault = 0) => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.interval")}</Typography>
        <TextField
          label={i18n.t("flowBuilderSingleBlockModal.textFieldLabels.timeInSeconds")}
  ...
  const documentLayout = (number, valueDefault = "") => {
    return (
      ...
      >
        ...
        <Typography textAlign={"center"}>{i18n.t("flowBuilderSingleBlockModal.headings.document")}</Typography>
        <div
        ...
        {valueDefault.length === 0 && (
          ...
          >
            {i18n.t("flowBuilderSingleBlockModal.buttons.sendDocument")}
            <input
              type="file"
              accept=".doc,.docx,.pdf"
              hidden
  ...
  const handleChangeDocuments = (e, number) => {
    ...
    if (e.target.files[0].size > 10000000) {
      toast.error(i18n.t("flowBuilderSingleBlockModal.toasts.fileTooLarge10mb"));
      return;
    }
  ...
  useEffect(() => {
    ...
    if (open === "edit") {
      setLabels({
        title: i18n.t("flowBuilderSingleBlockModal.labels.editTitle"),
        btn: i18n.t("flowBuilderSingleBlockModal.labels.btnSave"),
      });
    ...
    if (open === "create") {
      setLabels({
        title: i18n.t("flowBuilderSingleBlockModal.labels.addMenuTitle"),
        btn: i18n.t("flowBuilderSingleBlockModal.labels.btn"),
      });
      setTextDig();
      setArrayOption([]);
      ...
      setTimeout(async () => {
        if (
          ...
          try {
            ...
            toast.success(i18n.t("flowBuilderSingleBlockModal.toasts.contentSuccessAdded"));
            handleClose();
            setLoading(false);
      ...
      <Dialog open={activeModal} fullWidth="lg" scroll="paper">
          ...
          >
            ...
            <Stack direction={"row"} gap={1}>
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.text")}
              </Button>
              {/* Intervalo */}
              <Button
                variant="contained"
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.interval")}
              </Button>
              {/* Imagem */}
              <Button
                variant="contained"
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.image")}
              </Button>
              {/* Audio */}
              <Button
                variant="contained"
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.audio")}
              </Button>
              {/* Video */}
              <Button
                variant="contained"
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.video")}
              </Button>
              {/* Documento */}
              <Button
                variant="contained"
              ...
              >
                ...
                />
                {i18n.t("flowBuilderSingleBlockModal.buttons.document")}
              </Button>
            </Stack>
            <Box style={{ width: "100%", textAlign: "center" }}>
              <div className="shadow- py-2 font-bold bg-blue-900 rounded text-white">
                {i18n.t("flowBuilderSingleBlockModal.headings.variables")}
              </div>
              {variables && (
        ...
        {loading && (
          ...
          >
            <Stack>
              <Typography>
                {i18n.t("flowBuilderSingleBlockModal.misc.uploadingAndCreating")}
              </Typography>
